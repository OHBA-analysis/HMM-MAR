function Gamma = checkGammaOverfitting(Gamma,residuals,hmm,T,orders)
...
for k=1:hmm.train.logisticYdim
...
for k=1:hmm.train.logisticYdim+1
    for l=k:hmm.train.logisticYdim+1

function Gamma = padGamma(Gamma,T,options,do_upsample)
...
% and upsampling in case options.downsample was specified and the option
% up_sample is set to true
% 
% Author: Diego Vidaurre, OHBA, University of Oxford (2017)

if nargin < 4, do_upsample = true; end

do_upsample = do_upsample && ...
    (isfield(options,'downsample') && options.downsample > 0); 

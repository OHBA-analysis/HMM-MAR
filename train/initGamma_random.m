function Gamma = initGamma_random(T,K,D,Pstructure,Pistructure,additiveHMM,priorOFFvsON)
...
% if additiveHMM, D must be a 2x2 matrix of prior transitions - or left
%   empty
...
if nargin < 6, additiveHMM = false; end 

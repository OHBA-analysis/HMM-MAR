function Gamma = ehmminit_fromhmm(Gamma,T,options)
%
% Initialise the ehmm chain using a previously run HMM, with K+1 states
%
% INPUT
...
if isfield(options,'ehmm_initfromhmm_crit'), crit = options.ehmm_initfromhmm_crit;
else, crit = 1; 
end
